...
EXTERN_C BOOL ELOAMAPI EloamVideo_SetCropState(HELOAMVIDEO video, int state);
...
EXTERN_C BOOL ELOAMAPI EloamView_SetRectangleFormat(HELOAMVIEW view, int lineStyle, int lineSize, COLORREF lineColor,
	int pointStyle, int pointSize, COLORREF pointColor);
